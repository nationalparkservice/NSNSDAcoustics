...
#' Night Skies Division to process and explore audio data using BirdNET.
#'
#' Spectrograms show a segment detected by BirdNET. Title of spectrogram indicates
#'  the segment audio file name.
#'
