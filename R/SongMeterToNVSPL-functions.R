...
# FUNCTION SongMeter_To_NVSPL ====================================================

#' @name SongMeter_To_NVSPL
...
#' @param input.directory Top-level input directory path to audio files to be processed. e.g. E:/AUDIO
...
#' @param envir Use 1 or water and 2 for air. (CB: I am not sure the difference/utility of having this argument vs. the previous one?)
#' @param rescWat Use 1 if you want to re-scale underwater values to be able to plot using AMT, 0 if not
#' @param timezone Specify timezone used in the SongMeter (e.g, 'GMT')
#' @return If test.file = TRUE, returns diagnostics. If test.file = FALSE, returns NVSPL txt files in NVSPL folder generated by the function. \strong{NOTE TO SELF: we need to go through and document every column in the output of this --i.e. what does INVID and GChar1 etc etc mean -- where is metadata located for this?}
#' @details
#'
...
}  # end SongMeter_To_NVSPL function
