...
#' @description Convert NVSPLs (generated by PAMGuide) into acoustic indices. This version uses the code from "calculate_NVSPLtoAI_Generic.R" located under Synology / GLBA Phenology / June2020Upload
