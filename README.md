...
- **[Assessing BirdNET results](#assessing-birdnet-results)**: Go here if you already have raw BirdNET outputs in hand from rtype = 'r', and want to use R to wrangle, visualize, and verify the results.
  ...
  * **[Create heat maps of BirdNET detections](#create-heat-maps-of-birdnet-detections)**
...
### Create heat maps of BirdNET detections
...
**Click image for a larger version.**
<p align="center">
<img src=https://github.com/nationalparkservice/NSNSDAcoustics/blob/main/images/heatmap.png 
